...
def open_gui():
    ...
    tk.Radiobutton(frame_mode, text="Stretch (fill screen)", variable=mode_var, value="resize",
                   command=update_preview).pack(side="left", padx=2)
    tk.Radiobutton(frame_mode, text="Crop and center", variable=mode_var, value="center", command=update_preview).pack(
        side="left", padx=2)

    tk.Label(window, text="Background color:").grid(row=2, column=0, sticky="w", padx=2, pady=2)
    bg_color_menu = ttk.Combobox(window, textvariable=bg_color_var, values=list(minitel_color_names.keys()),
                                 state='readonly')
    ...
    tk.Radiobutton(frame_preview_mode, text="Color", variable=preview_mode_var, value="Color",
                   command=update_preview).pack(side="left", padx=2)
    tk.Radiobutton(frame_preview_mode, text="Grayscale", variable=preview_mode_var, value="Grayscale",
                   command=update_preview).pack(side="left", padx=2)
    ...
    model_menu = ttk.Combobox(window, textvariable=model_var,
                              values=["Minitel 1", "Minitel 1B and later", "Minitel 2 or Magis Club"], state='readonly')
    ...
    tk.Button(window, text="Send image to Minitel", command=send_image_to_minitel).grid(row=11, column=0, columnspan=3,
